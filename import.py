...
def main():
    ...
    db.execute("CREATE TABLE IF NOT EXISTS reviews (id SERIAL PRIMARY KEY, rating INTEGER NOT NULL, review_text VARCHAR NOT NULL, review_user_id INTEGER NOT NULL REFERENCES users(id), rbook_isbn VARCHAR NOT NULL REFERENCES books(isbn))")
